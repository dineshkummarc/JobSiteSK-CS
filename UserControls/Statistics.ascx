...
<table cellspacing="0" cellpadding="5" border="1">
    ...
    <tr>
        <td nowrap="nowrap" align="right" width="50%">
            <asp:Label ID="Label1" Text="Total Jobs :" Runat="server" SkinID="FormLabel"></asp:Label>
        </td>
    ...
    <tr>
        <td nowrap="nowrap" align="right" width="50%">
            <asp:Label ID="Label2" Text="Total Resumes :" Runat="server" SkinID="FormLabel"></asp:Label>
        </td>
        <td align="left" width="50%">
    ...
    <tr>
        <td nowrap="nowrap" align="right" width="50%">
            <asp:Label ID="Label3" Text="Total Companies :" Runat="server" 
